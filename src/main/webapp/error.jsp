        ...
        <div class="row message">
          <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="item text-center">
              <div class="h1">
                <% if(request.getParameter("error-title") == null) {%>
                	エラーが発生しました
                <% } else { %>
                	<%= request.getParameter("error-title") %>
                <% } %>
              </div>
              <div class="h6 mt-4">
              ...
              <!--ホームボタン-->
              <div class="d-grid mt-5 col">
                <a type="button" href="home" class="btn btn-success mb-3">Home</a>
              </div>
            </div>
          </div>
        </div>
