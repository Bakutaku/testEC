...
<body>
  ...
  <div class="body">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav col-md-auto me-md-auto">
              ...
              <li class="nav-item">
                <a class="nav-link link-light" aria-current="page" href="history">
    ...
    <div class="container-fluid main">
      <div class="ad">
        <div id="ad" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner ad-item">
            <div class="carousel-item active">
              <img src="img/ad_info.png" class="d-block w-100 img-fluid">
            </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col m-3 bg-light d-flex justify-content-center">
          <div class="h2">商品一覧</div>
        </div>
      </div>
    </div>
    <!--商品一覧-->
    ...
    <div class="item-List">
      <div class="container-fluid">
        <div class="row">
          ...
          <!--商品１つ-->
          <% for(Item item : list) {%>
	          <div class="col-sm-4 mb-3 mb-sm-0 mt-sm-2">
	            <div class="card">
	              <div class="d-flex align-items-center">
	                <img src="<%= item.getImage()%>" class="card-img-top">
	              </div>
	              <div class="card-body">
	              ...
	              <ul class="list-group list-group-flush">
	                ...
	                <li class="list-group-item">
	                  <div class="form-floating mb-1">
	                    <input name="<%= item.getId() %>" type="number" class="form-control" min="1" max="<%= item.getInventory() %>" value="1" <% if(item.getInventory() <= 0){ %>disabled<% } %>>
	                    <label for="floatingInput">個数</label>
	                  </div>
	                  <div class="d-grid gap-2">
	                    <button name="cart" value="<%=item.getId() %>" class="btn btn-success" type="submit" <% if(item.getInventory() <= 0){ %>disabled<% } %>>カートに入れる</button>
	                  </div>
	                </li>
	                <li class="list-group-item">
	                  <div class="d-grid gap-2">
	                    <a href="info?item=<%=item.getId() %>" target="_blank" rel="noopener" class="btn btn-primary" type="button">詳細</a>
	                  </div>
	                </li>
	              </ul>
	            </div>
